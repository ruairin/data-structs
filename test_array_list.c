...
int test_array_list(void)
{
  ...
  assert((value == 10) && "Error: expected 10 at index 0");
  list_get(my_list, 1, &value);
  assert((value == 20) && "Error: expected 20 at index 1");
  list_get(my_list, 2, &value);
  assert((value == 30) && "Error: expected 30 at index 2");
  ...
  assert(list_size(my_list) == 2 && "Error: Incorrect list size after remove");
  list_get(my_list, list_size(my_list) - 1, &value);
  assert((value == 20) && "Error: expected 20 at index 1");
  printf("List Contents:");
  print_list(my_list, 0, list_size(my_list) - 1);
  printf("List Size: %d\n", list_size(my_list));
  ...
  assert(list_size(my_list) == 1 && "Error: Incorrect list size after remove");
  list_get(my_list, list_size(my_list) - 1, &value);
  assert((value == 20) && "Error: expected 20 at index 0");
  printf("List Contents:");
  print_list(my_list, 0, list_size(my_list) - 1);
  printf("List Size: %d\n", list_size(my_list));
  ...
  assert(list_size(my_list) == 2 && "Error: Incorrect list size after insert");
  list_get(my_list, 0, &value);
  assert((value == 20) && "Error: expected 20 at index 0");
  list_get(my_list, list_size(my_list) - 1, &value);
  assert((value == 100) && "Error: expected 100 at last index");
  printf("List Contents:");
  print_list(my_list, 0, list_size(my_list) - 1);
  printf("List Size: %d\n", list_size(my_list));
  ...
  list_get(my_list, 0, &value);
  assert((value == 500) && "Error: expected 500 at index 0");
  ...
  assert(list_size(my_list) == 4 && "Error: Incorrect list size after insert");
  list_get(my_list, list_size(my_list) - 1, &value);
  assert((value == 500) && "Error: expected 500 at last index");
  printf("List Contents:");
  print_list(my_list, 0, list_size(my_list) - 1);
  printf("List Size: %d\n", list_size(my_list));
  printf("Insert test - OK\n");
  ...
  list_get(my_list, 0, &value);
  assert((value == -1000) && "Error: expected -1000 at index 0");
  printf("List Contents:");
  print_list(my_list, 0, list_size(my_list) - 1);
  printf("List Size: %d\n", list_size(my_list));
  ...
  list_get(my_list, list_size(my_list) - 1, &value);
  assert((value == -1000) && "Error: expected -1000 at last index");
  printf("List Contents:");
  print_list(my_list, 0, list_size(my_list) - 1);
  printf("List Size: %d\n", list_size(my_list));
  printf("Set test - OK\n");
  ...
  assert(list_size(my_list) == 1004 && "Error: Incorrect list size after appending 1000 items");

  printf("\n--- Remove approx 1000 items ---\n");
